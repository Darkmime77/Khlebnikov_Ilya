...
class Users(Base):
    ...
    balance = Column("balance", Double, nullable=True)
...
class Transport(Base):
    ...
    latitube = Column("latitube", Double, nullable=True)
    longitube = Column("longitude", Double, nullable=True)
    minutePrice = Column("minutePrice", Double)
    dayPrice = Column("dayPrice", Double)
...
class Rent(Base):
    ...
    priceOfUnit = Column("priceOfUnit", Double, nullable=True)
    priceType = Column("priceType", String, nullable=True)
    finalPrice = Column("finalPrice", Double)
